...
public class ThereAndBackAgain 
{
	...
	public static void main(String[] args) 
	{
		...
		Traveler[] party1 = new Traveler[] {frodo, sam, gimli};
		
		for(Traveler traveler : party1)
		{
			traveler.travel(50);
			System.out.println(traveler.getName() + " has traveled " + traveler.getDistanceTraveled()
								+ " miles.");
		}
	...
	public static String allTravel(ArrayList<Traveler> party, int miles)
	{
		...
		for(Traveler traveler : party) {
			...
			report += traveler.getName() + " has traveled " + traveler.getDistanceTraveled() + " miles.\n";
		}
